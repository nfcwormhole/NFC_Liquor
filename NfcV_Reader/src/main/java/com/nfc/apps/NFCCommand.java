...
public class NFCCommand {
    ...
    //* the argument myTag is the intent triggered with the TAG_DISCOVERED
    //***********************************************************************/
    //public static byte[] SendGetSystemInfoCommandCustom_Inventory (Tag myTag, DataDevice ma)
    public static byte[] SendGetSystemInfoCommandCustom(Tag myTag, DataDevice ma) {
        ...
        if (response[9] == (byte) 0xE0) {
            ...
            } else if (response[8] == (byte) 0x01) //MOTOROLA (updated 20140228)
            {
                ma.setManufacturer("Motorola");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x03) //HITASHI (updated 20140228)
            {
                ma.setManufacturer("Hitachi");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x04) //NXP SEMICONDUCTORS
            {
                ma.setManufacturer("NXP");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x05) //INFINEON TECHNOLOGIES (updated 20140228)
            {
                ma.setManufacturer("Infineon");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x06) //CYLINC (updated 20140228)
            {
                ma.setManufacturer("Cylinc");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x07) //TEXAS INSTRUMENTS TAG-IT
            {
                ma.setManufacturer("Texas Instruments");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x08) //FUJITSU LIMITED (updated 20140228)
            {
                ma.setManufacturer("Fujitsu");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x09) //MATSUSHITA ELECTRIC INDUSTRIAL (updated 20140228)
            {
                ma.setManufacturer("Matsushita");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x0A) //NEC (updated 20140228)
            {
                ma.setManufacturer("NEC");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x0B) //OKI ELECTRIC (updated 20140228)
            {
                ma.setManufacturer("Oki");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x0C) //TOSHIBA (updated 20140228)
            {
                ma.setManufacturer("Toshiba");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x0D) //MITSUBISHI ELECTRIC (updated 20140228)
            {
                ma.setManufacturer("Mitsubishi");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x0E) //SAMSUNG ELECTRONICS (updated 20140228)
            {
                ma.setManufacturer("Samsung");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x0F) //HUYNDAI ELECTRONICS (updated 20140228)
            {
                ma.setManufacturer("Hyundai");
                ma.setBasedOnTwoBytesAddress(false);
                boolDeviceDetected = true;
            } else if (response[8] == (byte) 0x10) //LG SEMICONDUCTORS (updated 20140228)
            {
    ...
    public static byte[] SendWriteSingleBlockCommand(Tag myTag, byte[] StartAddress, byte[] DataToWrite, DataDevice ma) {
        ...
        if (ma.isBasedOnTwoBytesAddress()) {
            if (ma.getManufacturer() == "Texas Instruments")
