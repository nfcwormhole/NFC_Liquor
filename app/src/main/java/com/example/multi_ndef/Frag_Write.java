...
* File Name        : Frag_Write.java
* Author           : Systems Lab
* Version          : 1.0
* Date             : 1st Sep, 2014
* Description      : Frag_Write
********************************************************************************
...
public class Frag_Write extends FragmentActivity  implements OnClickListener{
	Button write;
	 String network_name;
     String[] mac_add;
     String password;
...
//			 int a = 491;
			...
			boolean cardCheck = false; 
				...
				
				{
					...
					BT_Device_name=ma.getBT_Device_name();
					Mac_address=ma.getMac_address();
					index_bt_item=ma.getindex_bt_item();
	 ...
	 private class MyPagerAdapter extends FragmentPagerAdapter {
	        ...
	        public Fragment getItem(int pos) {
	            ...
	            case 0: return frag_text.newInstance("Telephone Number");
	            case 1: return frag_url.newInstance("Spinner");
	            case 2: return frag_wifi.newInstance("ThirdFragment, Instance 1");
	            case 3: return frag_bt.newInstance("ThirdFragment, Instance 2");
	            case 4: return frag_contact.newInstance("ThirdFragment, Instance 3");
	            case 5: return frag_sms.newInstance("ThirdFragment, Instance 3");
	            case 6: return frag_mail.newInstance("ThirdFragment, Instance 3");
	            case 7: return frag_telephone.newInstance("ThirdFragment, Instance 3");
	            case 8: return frag_location.newInstance("ThirdFragment, Instance 3");
	            default: return frag_location.newInstance("spinner");
	            }
	        }
