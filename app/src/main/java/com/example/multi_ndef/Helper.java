...
public class Helper {
	...
	//***********************************************************************/
	 ...
	 //***********************************************************************/
	public static String FormatStringAddressStart (String stringToFormat, CNFCInterface ma)
	{
	...
	//***********************************************************************/
	 ...
	 //* Example : FormatStringAddressStart ("FFFF") -> returns "07FF"
	 //***********************************************************************/
	public static String FormatStringNbBlock (String stringToformat, String sAddressStart,CNFCInterface ma)
	{
